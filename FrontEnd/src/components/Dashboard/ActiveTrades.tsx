...
export const ActiveTrades: React.FC<{ trackedWallet?: string | null }> = ({ trackedWallet }) => {
  ...
  // Determine which trades to use based on tracked wallet
  const [activeTrades, closedTrades] = useMemo(() => {
    const trades = trackedWallet 
      ? trackedTrades.filter(t => t.wallet_group === trackedWallet)
      : allTrades;
  ...
  }, [trackedWallet, allTrades, trackedTrades]);
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <h3 className="font-semibold text-white truncate max-w-[160px]" title={trade.token_address}>
                          {trade.token_address}
                        </h3>
