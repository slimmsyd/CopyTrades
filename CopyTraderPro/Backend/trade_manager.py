...
class TradeManager:
    """Manages trades and trade-related operations"""
    _instance = None
    _initialized = False
    ...
    def __init__(self):
        if not self._initialized:
            ...
            self._trades_file = os.path.join(self._data_dir, 'trades.json')
    ...
    def _save_trades(self):
        ...
        try:
            ...
            temp_file = f"{self._trades_file}.tmp"
            ...
            os.replace(temp_file, self._trades_file)
        except Exception as e:
        ...
        for trade in self.trades:
            if trade["status"] == "active":
                try:
                    ...
                    print(f"Error updating price for trade {trade['id']}: {str(e)}")
    ...
    def get_active_trades(self) -> List[Dict]:
        """Get active trades"""
        return [trade for trade in self.trades if trade["status"] == "active"]
