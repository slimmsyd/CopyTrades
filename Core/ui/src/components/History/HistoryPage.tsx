...
import { BarChart3, Calendar, ArrowUpRight, ArrowDownRight, ExternalLink, Filter, TrendingUp, DollarSign, Clock, Percent } from 'lucide-react';
import { useTrades } from '../../hooks/useTrades';

export const HistoryPage: React.FC = () => {
  const { trades, totalProfit, winRate, loading, error } = useTrades();
