...
export const Sidebar: React.FC<SidebarProps> = ({ currentPath }) => {
  ...
  return (
    <div className="w-64 bg-gray-900/50 backdrop-blur-xl p-4 border-r border-gray-800/50">
      ...
      <button className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-400 hover:bg-gray-800/50 hover:text-white transition-all duration-300 mt-auto absolute bottom-4">
        <LogOut size={20} />
        <span>Logout</span>
      </button>
    </div>
